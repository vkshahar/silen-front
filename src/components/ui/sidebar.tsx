...
// Updated navigation items based on Log Size Reduction Dashboard
const navigationItems: NavigationItem[] = [
  { id: "dashboard", name: "Log Size Reduction Dashboard", icon: BarChart3, href: "/" },
  { id: "source", name: "Source Management", icon: FileText, href: "/source" },
  { id: "destination", name: "Destination Management", icon: Settings, href: "/destination" },
  { id: "pipeline", name: "Pipeline Manager", icon: Activity, href: "/pipeline" },
  { id: "optimization", name: "Optimization Initiatives", icon: Target, href: "/optimization" },
  { id: "dehydrated", name: "Dehydrated Logs", icon: Archive, href: "/dehydrated" },
];
    ...
    <>
      ...
      <div
        className={`
          ...
          md:translate-x-0 md:sticky md:z-auto md:h-screen
          ${className}
        `}
      >
        ...
        <div className="flex items-center justify-between p-5 border-b border-slate-200 bg-slate-50/60">
          {!isCollapsed && (
            <div className="flex items-center space-x-2.5">
              ...
              <div className="flex flex-col">
                <span className="font-semibold text-slate-800 text-base">Silen</span>
          ...
          {isCollapsed && (
            <div className="w-9 h-9 bg-brand-primary rounded-lg flex items-center justify-center mx-auto shadow-sm">
              <span className="text-white font-bold text-base">S</span>
            </div>
          )}
                ...
                <li key={item.id}>
                  ...
                  >
                    ...
                    {isCollapsed && item.badge && (
                      <div className="absolute top-1 right-1 w-4 h-4 flex items-center justify-center rounded-full bg-brand-primary/20 border border-white">
